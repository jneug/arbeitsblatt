...
\DeclareExerciseEnvironmentTemplate{abnormal} {%
	\addpenalty{-3000}\smallskip\noindent\textbf{\rmfamily%
		% Falls Zusatzaufgabe:
		\textcolor{ab.aufgabe.icons}{\ifthenelse{\equal{\ExerciseType}{zusatzaufgabe}}{\llap{\GetExerciseProperty{icon}\ifmodulgeladen{icons}{\,\iconStern}{\,$\star$}}~}{\llap{\GetExerciseProperty{icon}~}}}%
