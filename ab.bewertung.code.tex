...
\RenewDocumentEnvironment {aufgabenteil} { s o } {%
	\refstepcounter{teilaufgabe}%
	\IfNoValueTF{#2}{%
		\tl_set:Nx \l__ab_tmpa_tl {\ab_taufg_id:nn {\GetExerciseProperty{ID}} {\alph{teilaufgabe}}}%
	}{%
...
\def\ab@ew@et@taufg#1#2{
	\detokenize{X &}
	#2 ~ #1
	\detokenize{& 0 & \tabularnewline\hline}
}
